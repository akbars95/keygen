...
<div style="width: 90%; margin: 0 auto">
    ...
    <p>Please go to this url:
        <span style="color: #2b542c; font-weight: bold;font-size: 12px;"><a href="${tempUrl}">Go to this link</span></a></p>
    <p>When you go to by link, which in top, you need set this temp password: <input type="text" readonly style="    color: blue;
    border: none;border-bottom: 1px solid green;" onmouseenter="selectAll('tempPassword')" id="tempPassword" value="${tempPassword}"></p>
